...
//|          ADX H1 : Filtre tendance ADX > seuil                    |
//|          SL Min : SL minimum basé sur spread + marge              |
...
//|      Paramètres : InpUseCooldown (bool) + InpCooldownBars (int) |
//|      Reset indépendant par direction (BUY / SELL).              |
//+------------------------------------------------------------------+
#property copyright "HTF Gold EA v3.3 - MER Layer 1+2 + StoplossAreas + ADX + SpreadSL + Risk% + SpikeCooldown"
...
int OnInit()
{
   ...
   PrintFormat("HTF Gold EA v3.3 [MER-L1+L2] | %s | H1: %s%s | SL/TP: %s | MSB: %s | Cooldown: %s",
               g_symbol, filterName,
