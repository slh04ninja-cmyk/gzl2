...
//+------------------------------------------------------------------+
#property copyright "EMA_ADX_Scalper_EA v2.4"
      ...
      if(g_t1_closed_profit)
        {
         ...
         // Chaque InpTrailStep pips au-dela du BE → SL avance d un step
         //
         // Exemple avec InpBE_Offset=2000 et InpTrailStep=1000 :
         //   profit 3000 pips → etape 1 → SL = entree + 3000 pips
         //   profit 4000 pips → etape 2 → SL = entree + 4000 pips
         //   profit 5000 pips → etape 3 → SL = entree + 5000 pips
         //-----------------------------------------------------------
         double beyond_be   = profit_dist - be_offset;

         if(beyond_be > 0)
           {
            int    etapes        = (int)MathFloor(beyond_be / trail_dist);
