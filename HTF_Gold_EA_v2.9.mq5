...
//+------------------------------------------------------------------+
#property copyright "HTF Gold EA v2.9 - MER Layer 1+2"
...
input int               InpMSB_SwingBars    = 5;             // Bougies pour détecter swing high/low
input ENUM_MSB_BREAK    InpMSB_BreakType    = MSB_BREAK_CLOSE; // Condition de cassure
input ENUM_MSB_TIMING   InpMSB_Timing       = MSB_TIMING_AFTER; // MSB avant ou après le spike
