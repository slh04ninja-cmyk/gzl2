...
input bool              InpH1_ConfirmH1Bar  = true;          // [EMA] Confirmer biais : prix actuel vs Open H1[0]
...
int OnInit()
{
   ...
   PrintFormat("HTF Gold EA v2.6 [MER-L1] | %s | H1: %s%s | SL/TP: %s",
               symbol, filterName,
