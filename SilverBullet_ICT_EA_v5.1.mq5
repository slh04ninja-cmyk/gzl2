...
//+------------------------------------------------------------------+
#property copyright "Silver Bullet ICT v5.1"
...
int OnInit()
{
   ...
   Print("=== Silver Bullet ICT v5.1 | ", _Symbol, " | M5 ===");
   Print("EMA Fast:", InpEMA_Fast, " | EMA Slow:", InpEMA_Slow);
